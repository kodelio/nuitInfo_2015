...
if ((isset($_POST['UserIDEmploye'])) AND ($_POST['UserIDEmploye']!="")){
  $bdd = new PDO('mysql:host=localhost;dbname=rgdyprykza;charset=utf8', 'rgdyprykza', 'rRv2tVZK6P');
  $myquery = $bdd->prepare("INSERT INTO asso_chef_user(ID_USER, ID_CHEF) VALUES(?,?);");
  $myquery->execute(array($_POST['UserIDEmploye'],$_SESSION['IDUSER']));
}
if(isset($_SESSION['TYPEUSER']) && $_SESSION['TYPEUSER'] == 2)
{
  ...
  <head>
    ...
    <title>Alt-F4 | Formulaire Chef - Employé</title>
  ...
  <div class="col-md-12 form">
    <div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title">Ajouter à ma liste d'employé</h3>
      </div><!-- /.box-header -->
      <!-- form start -->
      <form class="form-horizontal" method="POST">
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="criseOperation" class="col-sm-2 control-label">Employé</label>
            <div class="col-sm-9">
              <select class="form-control" id="UserIDEmploye" name="UserIDEmploye" required>
                <?php
                $bdd = new PDO('mysql:host=localhost;dbname=rgdyprykza;charset=utf8', 'rgdyprykza', 'rRv2tVZK6P');
                $myquery = $bdd->prepare("Select ID_USER, LOGIN from utilisateur where TYPE_USER=1 ;");
